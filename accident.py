...
def render():
    ...
    <div class="hero-banner">
        <div class="hero-title">🚗 AI Accident Detection Intelligence</div>
        <div class="hero-text">
    ...
    with left:
        st.markdown("""
        <div class="card">
            <div class="card-title">📤 Upload Traffic Image</div>
            <div class="card-text">Supported formats: JPG, JPEG, PNG</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with right:
        st.markdown("""
        <div class="card">
            <div class="card-title">🧠 AI Detection Engine</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    if uploaded_file is not None:
        ...
        st.markdown("""
        <div class="card">
            <div class="card-title">🖼 Uploaded Preview</div>
            <div class="card-text">
