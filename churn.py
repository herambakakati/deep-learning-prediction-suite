...
def render():
    ...
    <div class="hero-banner">
        <div class="hero-title">📉 AI Customer Churn Intelligence</div>
        <div class="hero-text">
    ...
    with left:
        ...
        <div class="form-card">
            ...
            <div class="card-subtitle">
                Complete customer demographic, financial, and product information.
            </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with right:
        ...
        <div class="form-card orange-card">
            <div class="card-title">🏦 Banking Attributes</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    if st.button("✨ Analyze Customer Churn Risk"):
        ...
        <div class="prediction-box">
            <div class="prediction-title">Prediction Score</div>
            <div class="prediction-score">{prediction:.4f}</div>
        </div>
        """, unsafe_allow_html=True)
        ...
        if prediction > 0.5:
            ...
            <div class="danger-box">
                <div class="danger-title">⚠️ High Churn Risk</div>
                <div class="danger-sub">{prediction * 100:.2f}% Probability</div>
            </div>
            """, unsafe_allow_html=True)
        else:
            st.markdown(f"""
            <div class="safe-box">
                <div class="safe-title">✅ Customer Likely To Stay</div>
                <div class="safe-sub">{(1 - prediction) * 100:.2f}% Confidence</div>
            </div>
            """, unsafe_allow_html=True)